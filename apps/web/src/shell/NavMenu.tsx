...
export const NAV_ENTRIES: NavEntry[] = [
  { path: "/p11", label: "价格健康", group: "行业" },
  { path: "/p12", label: "经营目标", group: "行业" },
  { path: "/p13", label: "订单全流程", group: "行业" },
  { path: "/p14", label: "渠道运营", group: "行业" },
  { path: "/p15", label: "口碑与差评", group: "行业" },
  { path: "/p16", label: "AI 语音前台", group: "行业" },
  { path: "/p17", label: "前厅与客房", group: "行业" },
  { path: "/p18", label: "多店驾驶舱", group: "行业" },
  { path: "/p19", label: "收益分析", group: "行业" },
  { path: "/p20", label: "门店档案全景", group: "行业" },
  ...
  { path: "/p10", label: "片库 · 内容资产", group: "系统" },
];
